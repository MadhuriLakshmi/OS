...
public class MainFrame extends JFrame implements ActionListener {
	...
	String[] alogorithmNames = { "FCFS", "SSTF", "SCAN", "CSCAN", "LOOK",
			"CLOOK" };
	String[] nameOfTheButtons = { "input", "run"
			 };
	...
	public void initComponents() {
		graphPanel_ = new JPanel();
		 graphPanel_.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "", TitledBorder.RIGHT, TitledBorder.TOP, null, new Color(0, 0, 0)));
	...
	//	graphPanel_.setBackground(Color.white);
		...
		inputPanel_.setPreferredSize(new Dimension(250, 250));
		inputPanel_.setBackground(Color.white);

		buttonPanel_ = new JPanel();
		buttonPanel_.setPreferredSize(new Dimension(250, 150));
		buttonPanel_.setBorder(new TitledBorder("Buttons"));

		head = new JLabel("Head Position: ");

		getContentPane().add(graphPanel_);
		getContentPane().add(inputPanel_);
		getContentPane().add(buttonPanel_);
